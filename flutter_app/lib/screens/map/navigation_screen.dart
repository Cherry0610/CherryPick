        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: kWhite,
              border: Border(
                top: BorderSide(color: kMediumGray.withOpacity(0.2)),
              ),
            ),
            child: SizedBox(
              width: double.infinity,
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Container(width: 1, height: 40, color: kWhite.withOpacity(0.2)),
              Expanded(
                child: _buildRouteStat(
                  Icons.access_time,
                  '${route.duration} min',
  ...
  Widget _buildRouteStat(IconData icon, String value, String label) {
    return Column(
      children: [
        ...
        Text(
          label,
          style: TextStyle(color: kWhite.withOpacity(0.7), fontSize: 10),
        ),
      ],
    );
  }
